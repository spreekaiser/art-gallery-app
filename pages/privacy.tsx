...
import { Country, LegalContainer, LegalLink } from "../styles/legals.style";
import Image from "next/image";

export default function PrivacyPage({ isLoading }: ILegalPageProps) {
  ...
  return (
    <LegalContainer>
      ...
      <p>
        Kommentare werden ausschließlich im LocalStorage Ihres Browsers
        gespeichert und sind nur in Ihrem Browser verfügbar.
      </p>
      <p>
        <span>Quelle: </span>
        <LegalLink href="https://www.e-recht24.de/muster-datenschutzerklaerung.html">
